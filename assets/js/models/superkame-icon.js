class Kame2 {
    ...
    constructor (ctx, x, y, vx, w = KAME2_W, h = KAME2_H, damage = KAME2,) {
        ...
        this.spriteRigth.src = KAME2_RIGHT_SRC;
        ...
        this.spriteLeft.src = KAME2_LEFT_SRC; 
    ...
    animate () {
        if (this.drawCount >= KAME2_ANIMATION_FREQ) {
            this.drawCount = 0;
